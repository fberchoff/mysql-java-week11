...
public class ProjectsApp {
	...
	private void deleteProject() {
		...
		Integer projectId = getIntInput("\nEnter the project ID of the project to delete");
		
		projectService.deleteProject(projectId);
		
		System.out.println("Project with project ID=" + projectId + " is now deleted.");
		
		if (!Objects.isNull(curProject) && curProject.getProjectId() == projectId) curProject = null;
